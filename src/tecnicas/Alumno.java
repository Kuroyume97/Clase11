...
public class Alumno extends Persona {
    ...
    public static void main(String[] args) {
        ...
        for (i = 1; i <= limite; i++) {
            ...
            notas.setGenero(JOptionPane.showInputDialog("Ingrese el genero del alumno").charAt(0));
        ...
        JOptionPane.showMessageDialog(null, "El promedio del grupal es: " + promediototal);
    }
}
